...
public class SynchList {
	...
	public void add(Object o) {
		...
		lock.acquire();
		System.out.println (KThread.currentThread().getName() + " added " + o + " to the list in " + name);
		list.add(o);
		listEmpty.wake();
		lock.release();
	}
	...
	public Object removeFirst() {
		...
		o = list.removeFirst();
		System.out.println (KThread.currentThread().getName() + " got first element (" + o + ") from " + name);
		lock.release();
	...
	public static void selfTest() {
		SynchList ping = new SynchList("ping");
		SynchList pong = new SynchList("pong");

		new KThread(new PingTest(ping, pong)).setName("thr").fork();
